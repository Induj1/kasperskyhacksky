...
const teamFormSchema = z.object({
  ...
  teamMembers: z.array(teamMemberSchema).length(2, { message: 'Exactly 2 team members required (plus leader = 3 total).' }),
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-cyber-darker p-6 rounded-lg border border-cyber-green/20 mb-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-300">
                  ...
                  <li>Teams must have exactly 3 members (including team leader)</li>
